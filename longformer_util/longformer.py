...
class LongformerConfig(RobertaConfig):
    def __init__(self, attention_window: List[int] = None, attention_dilation: List[int] = None,
        ...
        assert self.attention_mode in ['tvm', 'sliding_chunks', 'n2', 'sliding_chunks_no_overlap', 'dcg']
...
class LongformerSelfAttention(nn.Module):
    def __init__(self, config, layer_id):
        ...
        assert self.attention_mode in ['tvm', 'sliding_chunks', 'sliding_chunks_no_overlap', 'dcg']
    ...
    def forward(
        ...
        if remove_from_windowed_attention_mask is not None:
            ...
            #if (self.attention_mode == 'tvm' and repeat_size == 1): repeat_size = 2
